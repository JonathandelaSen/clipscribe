...
function toCreatorShortExportRecord(record: ProjectExportRecord): CreatorShortExportRecord {
  return {
    ...
    renderModeUsed: record.renderModeUsed,
    encoderUsed: record.encoderUsed,
    timingsMs: record.timingsMs as CreatorShortExportRecord["timingsMs"],
    counts: record.counts as CreatorShortExportRecord["counts"],
